...
const UNIFORMS = {
  // Site palette: white → #BDDDFC → #6A89A7 → #88BDF2
  colors: [[1,1,1],[0.7412,0.8667,0.9882],[0.4157,0.5373,0.6549],[0.5333,0.7412,0.949],[0.5333,0.7412,0.949],[0.5333,0.7412,0.949],[0.5333,0.7412,0.949],[0.5333,0.7412,0.949]] as [number, number, number][],
  colorCount: 4,
  scale: 1.300,
  intensity: 0.560,
  paramA: 0.670,
